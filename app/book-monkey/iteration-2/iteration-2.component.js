...
var IterationTwoComponent = (function () {
    ...
    IterationTwoComponent = __decorate([
        ...
        router_1.Routes([
            { path: '/dependency-injection', component: index_1.BookMonkeyAppComponent },
            { path: '/navigation', component: index_2.BookMonkeyAppComponent }
        ]), 
